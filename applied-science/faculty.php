              ...
              <div class="flip-card">
                <div class="flip-card-inner">
                  ...
                  <div class="flip-card-back">
                    <p class="faculty_name"><b>Mr. Gaikwad Tushar Balkrishna</b></p>
                    <p class="faculty_card_link"><b>Qualification: </b>M.Sc (Chemistry) - .(NET) Phd: Pursuing</p>
            ...
            <div class="col-md-3" id="faculty-card">
              <div class="flip-card">
                <div class="flip-card-inner">
                  ...
                  <div class="flip-card-back">
                    <p class="faculty_name"><b>Mr. Sachin Laxman Varpe</b></p>
                    <p class="faculty_card_link"><b>Qualification: </b> M.Sc.BEd.(Maths) Phd: Pursuing</p>
            ...
            <div class="col-md-3" id="faculty-card">
              <div class="flip-card">
                <div class="flip-card-inner">
                  ...
                  <div class="flip-card-back">
                    <p class="faculty_name"><b>Mr Shital Anant Patil</b></p>
                    <p class="faculty_card_link"><b>Qualification: </b>M.Sc(Mathematics)NET qualified Phd: Pursuing</p>
            ...
            <div class="col-md-3" id="faculty-card">
              <div class="flip-card">
                <div class="flip-card-inner">
                  ...
                  <div class="flip-card-back">
                    <p class="faculty_name"><b>Mr. Mahesh Madhukar Sarada</b></p>
                    <p class="faculty_card_link"><b>Qualification: </b>M.Tech(Mathematics) Phd: Pursuing</p>
                    <p class="faculty_card_link"><b>Experience: </b> <b>Teaching:</b> 11 Years</p>
            ...
            <div class="col-md-3" id="faculty-card">
              <div class="flip-card">
                <div class="flip-card-inner">
                  ...
                  <div class="flip-card-back">
                    <p class="faculty_name"><b>Mrs. Priya Balkrishna Oghe</b></p>
                    <p class="faculty_card_link"><b>Qualification: </b>M.Sc. Physics, B. Ed.( Maths & Physics) Phd: Pursuing</p>
            ...
            <div class="col-md-3" id="faculty-card">
              <div class="flip-card">
                <div class="flip-card-inner">
                  ...
                  <div class="flip-card-back">
                    <p class="faculty_name"><b>Mrs. Shrivastava Deepshikha</b></p>
                    <p class="faculty_card_link"><b>Qualification: </b>M.Tech (Control System) Phd: Pursuing</p>
            ...
            <div class="col-md-3" id="faculty-card">
              <div class="flip-card">
                <div class="flip-card-inner">
                  ...
                  <div class="flip-card-back">
                    <p class="faculty_name"><b>Mr. Sandeep S. Borgaonkar</b></p>
                    <p class="faculty_card_link"><b>Qualification: </b>M.Sc. (Physics) NET Phd: Pursuing</p>
