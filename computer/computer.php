		...
		<div class="container">
			<div class="row">
				...
				<div class="col-xs-12 col-sm-12 col-md-9">
					...
					<p>Globally, Computer Engineering skills continue to be in high demand from businesses in many sectors and this field is experiencing explosive growth. 
					This Computer Engineering degree is designed to meet the needs of these businesses, to pursue a rewarding career. The curriculum designed by SPPU is followed which combines theoretical knowledge with practical experiments to prepare for the world of work. 
					This program is the right choice for students who aspire the IT sector and have that zeal to be a tool proficient.<br><br>
					The Department of Computer Engineering at Pimpri Chinchwad College of Engineering and Research (PCCOE&R) was established in the year 2015 with an initial
					intake of 60 students in undergraduate degree programme and enhanced its intake to 120 in the year 2020. The Department works on Outcome Based Philosophy (OBE), in which, we focus and organize the entire programme and all the instructional efforts around the clearly defined outcomes that we want our students to demonstrate when they leave the institute.
					We endeavor to deliver such contents and to exercise such pedagogies and assessment that our students achieve high order learning and mastery, instead of just accumulating credits.<br><br>
					Department runs a UG programme in Computer Engineering, which is a 4 years, 8 semesters full time programme. Department has adequate number of Faculty
					members and supporting staff, which is well qualified, experienced and dedicated. Department has spacious classrooms, tutorial room, a department lobby(e-Shishyakulam), a project & research lab and experimentation laboratories equipped with latest equipment which are used in field. The laboratories include Multimedia Lab, Web Development Lab, Programming Lab, DE & MP LAB, Computer Network Lab, Database Lab, Computer Center.<br><br>
					The department believes in student-centric, research oriented course delivery and aims to produce industry ready engineering workforce who are culturally
					vibrant, socially sensitive and enterprising with leadership qualities. Sincere efforts and sense of responsibility by faculty members shows their maturity 
					to understand the problems of students and nurture them accordingly.<br><br></p>
					...
					<p>	<b>PEO1:</b> To prepare globally competent graduates having strong fundamentals, domain knowledge, updated with modern technology to provide the effective solutions for engineering problems.<br>
						...
						<b>PEO4:</b> To prepare the graduates with strong managerial and communication skills to work effectively as individual as well as in teams.<br></p>					
